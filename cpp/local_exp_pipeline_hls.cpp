...
#pragma HLS unroll
                        if (((i == 1) && (j == 1)) || ((x + j - 1) < 0) || ((x + j - 1) >= expn_region_w) || ((y + i - 1) < 0) || ((y + i - 1) >= expn_region_h)){
                            ...
                            bool flag = ((p_gray_nb - p_gray) < 10) && ((p_gray_nb - p_gray) > -10);
                            disp_range d_prop_diff = (d_prop > d_nb) ? (d_prop - d_nb) : (d_nb - d_prop);
                            disp_range d_orig_diff = (d_orig > d_nb) ? (d_orig - d_nb) : (d_nb - d_orig);
                            cost_binary_prop_array[i * 3 + j] = (flag == true) ? d_prop_diff.range(16, 2) : d_prop_diff.range(16, 4);
                            cost_binary_orig_array[i * 3 + j] = (flag == true) ? d_orig_diff.range(16, 2) : d_orig_diff.range(16, 4);
                        }
                    }
                }
                for (int i = 0; i < 3; i++) {
...
void layer0Calc(int iter, ap_uint<32> Q[LAYER0_PROP_NUM][4096], ap_uint<32> I[LAYER0_PROP_NUM], ap_uint<32> C[LAYER0_PROP_NUM], 
...
void layer0CacheWrapper(int iter, int unary_cost_x3, int buff_id, 
    unary_cost_t local_unary_cost[LAYER0_SIZE * 3][4][LAYER0_SIZE][DISP_DDR_MAX], 
    unary_cost_t ddr_unary_cost[WIDTH * HEIGHT * DISP_DDR_MAX]) {
#pragma HLS inline off
// #pragma HLS array_partition variable=local_unary_cost type=complete dim=1
// #pragma HLS array_partition variable=local_unary_cost type=complete dim=2
// DO_PRAGMA(HLS array_reshape variable=local_unary_cost type=cyclic factor=DISP_DDR_NUM dim=4)   
// #pragma HLS interface mode=m_axi bundle=BUS_LAYER0 port=ddr_unary_cost offset=slave
    ...
    if (iter < (LAYER0_VER_REGION_NUM * LAYER0_HOR_REGION_NUM - 2)) {
        layer0InloopCache(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, unary_cost_x3, local_unary_cost, ddr_unary_cost);
    }
...
void layer0CalcWrapper(int iter, int ver_region_num, int hor_region_num, int unary_cost_x0, int unary_cost_x1, int unary_cost_x2,
...
#pragma HLS inline off
    if (iter < ver_region_num * hor_region_num) {
        layer0Calc(iter, Q, I, C, unary_cost_x0, unary_cost_x1, unary_cost_x2, local_unary_cost, local_cost, local_label, local_disp);
    }
}
...
void layer0LoadCalcTransWrapper(int iter, int ver_region_num, int hor_region_num, ap_uint<DISP_DDR_BIT> uram_cost[LAYER0_SIZE * 3][WIDTH], label_range uram_label[LAYER0_SIZE * 3][WIDTH][3], disp_range uram_disp[LAYER0_SIZE * 3][WIDTH],
    ap_uint<DISP_DDR_BIT> local_cost[LAYER0_SIZE * 3][LAYER0_SIZE * 3], label_range local_label[LAYER0_SIZE * 3][LAYER0_SIZE * 3][3], disp_range local_disp[LAYER0_SIZE * 3][LAYER0_SIZE * 3],
    ap_uint<DISP_DDR_BIT> local_trans_cost[LAYER0_SIZE][LAYER0_SIZE], label_range local_trans_label[LAYER0_SIZE][LAYER0_SIZE][3], disp_range local_trans_disp[LAYER0_SIZE][LAYER0_SIZE],
...
#pragma HLS inline off
    ...
    /* calculation */
    layer0CalcWrapper(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, unary_cost_x0, unary_cost_x1, unary_cost_x2, Q, I, C, local_unary_cost, local_cost, local_label, local_disp);
    /* transmission */
    layer0TransWrapper(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, cost_blk_out, label_blk_out, disp_blk_out, init_cost_blk_out, init_label_blk_out, init_disp_blk_out, local_trans_cost, local_trans_label, local_trans_disp);
}

void layer0InitCalcTransWrapper(int iter, int unary_cost_x0, int unary_cost_x1, int unary_cost_x2, int buff_id, 
    ap_uint<32> Q[LAYER0_PROP_NUM][4096], ap_uint<32> I[LAYER0_PROP_NUM], ap_uint<32> C[LAYER0_PROP_NUM], 
    unary_cost_t local_unary_cost[LAYER0_SIZE * 3][4][LAYER0_SIZE][DISP_DDR_MAX], 
    ap_uint<DISP_DDR_BIT> uram_cost[LAYER0_SIZE * 3][WIDTH], label_range uram_label[LAYER0_SIZE * 3][WIDTH][3], disp_range uram_disp[LAYER0_SIZE * 3][WIDTH], 
#if HLS_LAYER0_ONLY == 0
...
#pragma HLS array_partition variable=local_trans_label type=complete dim=3
#pragma HLS array_partition variable=local_trans_disp type=complete dim=1
    static ap_uint<DISP_DDR_BIT> local_init_cost[LAYER0_SIZE][LAYER0_SIZE]; 
    static label_range local_init_label[LAYER0_SIZE][LAYER0_SIZE][3];
    static disp_range local_init_disp[LAYER0_SIZE][LAYER0_SIZE];
#pragma HLS array_partition variable=local_init_cost type=complete dim=1
#pragma HLS array_partition variable=local_init_label type=complete dim=1
#pragma HLS array_partition variable=local_init_label type=complete dim=3
#pragma HLS array_partition variable=local_init_disp type=complete dim=1
...
// #pragma HLS array_partition variable=local_im0_gray_reorder type=complete dim=1
    ...
    layer0LoadCalcTransWrapper(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, uram_cost, uram_label, uram_disp, local_cost, local_label, local_disp, local_trans_cost, local_trans_label, local_trans_disp,
        unary_cost_x0, unary_cost_x1, unary_cost_x2, Q, I, C, cost_blk_out, label_blk_out, disp_blk_out, init_cost_blk_out, init_label_blk_out, init_disp_blk_out, local_unary_cost);
...
#pragma HLS array_partition variable=uram_disp type=complete dim=1
    // 
    static uchar local_im0_gray[LAYER0_SIZE * 3][4][LAYER0_SIZE];
#pragma HLS array_partition variable=local_im0_gray type=complete dim=1
#pragma HLS array_partition variable=local_im0_gray type=complete dim=2
...
#pragma HLS dependence variable=local_unary_cost type=intra false
        ...
        // 
        layer0CacheWrapper(iter, unary_cost_x3, !buff_id, local_unary_cost, ddr_unary_cost);
        // 
        layer0InitCalcTransWrapper(iter, unary_cost_x0, unary_cost_x1, unary_cost_x2, buff_id, Q, I, C, local_unary_cost, uram_cost, uram_label, uram_disp, cost_blk_out, label_blk_out, disp_blk_out, init_cost_blk_out, init_label_blk_out, init_disp_blk_out);
        buff_id = !buff_id;
...
void layer0OutloopCache(unary_cost_t local_unary_cost[4][LAYER0_SIZE][LAYER0_SIZE * 3][DISP_DDR_MAX],unary_cost_t ddr_unary_cost[WIDTH * HEIGHT * DISP_DDR_MAX]) {
#pragma HLS inline off
// #pragma HLS array_partition variable=local_unary_cost type=complete dim=1
// #pragma HLS array_partition variable=local_unary_cost type=complete dim=2
// DO_PRAGMA(HLS array_reshape variable=local_unary_cost type=cyclic factor=DISP_DDR_NUM dim=4)
...
void layer0InloopCache(int iter, int ver_region_num, int hor_region_num, int unary_cost_y, 
    unary_cost_t local_unary_cost[4][LAYER0_SIZE][LAYER0_SIZE * 3][DISP_DDR_MAX], unary_cost_t ddr_unary_cost[WIDTH * HEIGHT * DISP_DDR_MAX]) {
#pragma HLS inline
#pragma HLS array_partition variable=local_unary_cost type=complete dim=1
...
// #pragma HLS interface mode=m_axi bundle=BUS_LAYER0 port=ddr_unary_cost offset=slave
    ...
    for (int xyd = 0; xyd < LAYER0_SIZE * LAYER0_SIZE * 3 * DISP_DDR_MAX; xyd++) {
#pragma HLS pipeline II=1
        int y = xyd / (LAYER0_SIZE * 3 * DISP_DDR_MAX);
        int x = xyd % (LAYER0_SIZE * 3 * DISP_DDR_MAX) / DISP_DDR_MAX;
        int d = xyd % (LAYER0_SIZE * 3 * DISP_DDR_MAX) % DISP_DDR_MAX;      
        local_unary_cost[unary_cost_y][y][x][d] = ddr_unary_cost[((unit_region_y + y) * WIDTH + (expn_region_x + x)) * DISP_DDR_MAX + d]; 
    }
}

void layer0CacheWrapper(int iter, int unary_cost_y3, int buff_id, 
...
// #pragma HLS interface mode=m_axi bundle=BUS_LAYER0 port=ddr_unary_cost offset=slave
    ...
    /* cache unary cost from DDR */
    if (iter < (LAYER0_VER_REGION_NUM * LAYER0_HOR_REGION_NUM - 2)) {
        layer0InloopCache(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, unary_cost_y3, local_unary_cost, ddr_unary_cost);
    }
    // if (iter < (LAYER0_VER_REGION_NUM * LAYER0_HOR_REGION_NUM - LAYER0_HOR_REGION_NUM - 3)) {
    //     layer0InloopCacheInit(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, buff_id, local_unary_cost_init, ddr_unary_cost);
    // }
...
void layer0CalcWrapper(int iter, int ver_region_num, int hor_region_num, int unary_cost_y0, int unary_cost_y1, int unary_cost_y2,
    ap_uint<32> Q[LAYER0_PROP_NUM][4096], ap_uint<32> I[LAYER0_PROP_NUM], ap_uint<32> C[LAYER0_PROP_NUM],
    unary_cost_t local_unary_cost[4][LAYER0_SIZE][LAYER0_SIZE * 3][DISP_DDR_MAX],
    ap_uint<DISP_DDR_BIT> local_cost[LAYER0_SIZE * 3][LAYER0_SIZE * 3], label_range local_label[LAYER0_SIZE * 3][LAYER0_SIZE * 3][3], disp_range local_disp[LAYER0_SIZE * 3][LAYER0_SIZE * 3]) {
#pragma HLS inline off
    if (iter < ver_region_num * hor_region_num) {
        layer0Calc(iter, Q, I, C, unary_cost_y0, unary_cost_y1, unary_cost_y2, local_unary_cost, local_cost, local_label, local_disp);
    }
}
...
#pragma HLS unroll
            if ((init_unit_region_y + y) >= HEIGHT)
                continue;
            uram_cost[(init_unit_region_y + y)][((init_hor_region_i % 3) * LAYER0_SIZE + x)] = local_init_cost[y][x];
            uram_label[(init_unit_region_y + y)][((init_hor_region_i % 3) * LAYER0_SIZE + x)][0] = local_init_label[y][x][0];
            uram_label[(init_unit_region_y + y)][((init_hor_region_i % 3) * LAYER0_SIZE + x)][1] = local_init_label[y][x][1];
            uram_label[(init_unit_region_y + y)][((init_hor_region_i % 3) * LAYER0_SIZE + x)][2] = local_init_label[y][x][2];
            uram_disp[(init_unit_region_y + y)][((init_hor_region_i % 3) * LAYER0_SIZE + x)] = local_init_disp[y][x];
        }
    }
}
...
void layer0LoadCalcTransWrapper(int iter, int ver_region_num, int hor_region_num, 
    ap_uint<DISP_DDR_BIT> uram_cost[HEIGHT][LAYER0_SIZE * 3], label_range uram_label[HEIGHT][LAYER0_SIZE * 3][3], disp_range uram_disp[HEIGHT][LAYER0_SIZE * 3],
    ap_uint<DISP_DDR_BIT> local_cost[LAYER0_SIZE * 3][LAYER0_SIZE * 3], label_range local_label[LAYER0_SIZE * 3][LAYER0_SIZE * 3][3], disp_range local_disp[LAYER0_SIZE * 3][LAYER0_SIZE * 3],
    ap_uint<DISP_DDR_BIT> local_trans_cost[LAYER0_SIZE][LAYER0_SIZE], label_range local_trans_label[LAYER0_SIZE][LAYER0_SIZE][3], disp_range local_trans_disp[LAYER0_SIZE][LAYER0_SIZE],
...
#pragma HLS inline off
    ...
    layer0UramLoad(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, uram_cost, uram_label, uram_disp, local_cost, local_label, local_disp, local_trans_cost, local_trans_label, local_trans_disp);
    /* calculation */
    layer0CalcWrapper(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, unary_cost_y0, unary_cost_y1, unary_cost_y2, Q, I, C, local_unary_cost, local_cost, local_label, local_disp);
    /* transmission */
    layer0TransWrapper(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, cost_blk_out, label_blk_out, disp_blk_out, init_cost_blk_out, init_label_blk_out, init_disp_blk_out, local_trans_cost, local_trans_label, local_trans_disp);
}

void layer0InitCalcTransWrapper(int iter, int unary_cost_y0, int unary_cost_y1, int unary_cost_y2, int buff_id, 
    ap_uint<32> Q[LAYER0_PROP_NUM][4096], ap_uint<32> I[LAYER0_PROP_NUM], ap_uint<32> C[LAYER0_PROP_NUM], 
    unary_cost_t local_unary_cost[4][LAYER0_SIZE][LAYER0_SIZE * 3][DISP_DDR_MAX], 
    ap_uint<DISP_DDR_BIT> uram_cost[HEIGHT][LAYER0_SIZE * 3], label_range uram_label[HEIGHT][LAYER0_SIZE * 3][3], disp_range uram_disp[HEIGHT][LAYER0_SIZE * 3], 
#if HLS_LAYER0_ONLY == 0
...
#pragma HLS array_partition variable=local_trans_disp type=complete dim=2
    ...
    static label_range local_init_label[LAYER0_SIZE][LAYER0_SIZE][3];
    static disp_range local_init_disp[LAYER0_SIZE][LAYER0_SIZE];
#pragma HLS array_partition variable=local_init_cost type=complete dim=2
#pragma HLS array_partition variable=local_init_label type=complete dim=2
#pragma HLS array_partition variable=local_init_label type=complete dim=3
#pragma HLS array_partition variable=local_init_disp type=complete dim=2
    static ap_uint<DISP_DDR_BIT> local_cost[LAYER0_SIZE * 3][LAYER0_SIZE * 3];
// #pragma HLS bind_storage variable=local_cost type=RAM_T2P impl=bram
    static label_range local_label[LAYER0_SIZE * 3][LAYER0_SIZE * 3][3];
    static disp_range local_disp[LAYER0_SIZE * 3][LAYER0_SIZE * 3];
...
// #pragma HLS array_partition variable=local_im0_gray_reorder type=complete dim=1
    ...
    // layer0TransWrapper(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, cost_blk_out, label_blk_out, disp_blk_out, local_trans_cost, local_trans_label, local_trans_disp);
    layer0LoadCalcTransWrapper(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, uram_cost, uram_label, uram_disp, local_cost, local_label, local_disp, local_trans_cost, local_trans_label, local_trans_disp,
        unary_cost_y0, unary_cost_y1, unary_cost_y2, Q, I, C, cost_blk_out, label_blk_out, disp_blk_out, init_cost_blk_out, init_label_blk_out, init_disp_blk_out, local_unary_cost);
    /* init bottom-right unit region */
    layer0InitWrapper(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, buff_id, /* Q, I, C, Q1, I1, C1, Q2, I2, C2, Q3, I3, C3, Q4, I4, C4, Q5, I5, C5, */ local_init_cost, local_init_label, local_init_disp);
    /* save to uram */
    layer0UramStore(iter, LAYER0_VER_REGION_NUM, LAYER0_HOR_REGION_NUM, uram_cost, uram_label, uram_disp, local_cost, local_label, local_disp, local_init_cost, local_init_label, local_init_disp);
...
#pragma HLS dependence variable=local_unary_cost type=intra false
        ...
        // 
        layer0CacheWrapper(iter, unary_cost_y3, !buff_id, local_unary_cost, ddr_unary_cost);
        // 
        layer0InitCalcTransWrapper(iter, unary_cost_y0, unary_cost_y1, unary_cost_y2, buff_id, Q, I, C, local_unary_cost, uram_cost, uram_label, uram_disp, cost_blk_out, label_blk_out, disp_blk_out, init_cost_blk_out, init_label_blk_out, init_disp_blk_out);
        buff_id = !buff_id;
#if PRINT_STATUS == 1 && !defined(__SYNTHESIS__)
        printf("\rlayer0 process: %4d / %d", iter, (ver_region_num * hor_region_num + (hor_region_num + 2)) - 1);  
        fflush(stdout);
...
#endif // PROPOSER_RANDOM_INIT == 1
    unary_cost_t ddr_unary_cost_layer0[WIDTH * HEIGHT * DISP_DDR_MAX], uchar ddr_im0_gray_layer0[WIDTH * HEIGHT], 
    unary_cost_t ddr_unary_cost_layer1[WIDTH * HEIGHT * DISP_DDR_MAX], uchar ddr_im0_gray_layer1[WIDTH * HEIGHT], 
#if LAYER2_ENABLE == 1
...
#pragma HLS interface mode=m_axi bundle=BUS_LAYER0 port=ddr_unary_cost_layer0 offset=slave
#pragma HLS interface mode=m_axi bundle=BUS_LAYER0 port=ddr_im0_gray_layer0 offset=slave
// #pragma HLS interface mode=m_axi bundle=BUS_LAYER1_COST port=ddr_unary_cost_layer1 offset=slave
// #pragma HLS interface mode=m_axi bundle=BUS_LAYER1_IMG port=ddr_im0_gray_layer1 offset=slave
#pragma HLS interface mode=m_axi bundle=BUS_LAYER1 port=ddr_unary_cost_layer1 offset=slave
#pragma HLS interface mode=m_axi bundle=BUS_LAYER1 port=ddr_im0_gray_layer1 offset=slave
#if LAYER2_ENABLE == 1
...
#pragma HLS dataflow
    ...
    localExpLayer0(
        ...
        ddr_unary_cost_layer0, ddr_im0_gray_layer0, cost_blk, label_blk, disp_blk, init_cost_blk, init_label_blk, init_disp_blk);
#if LAYER2_ENABLE == 0
    localExpLayer1(
#if PROPOSER_RANDOM_INIT == 1
        l1_random_num, 
#endif // #if PROPOSER_RANDOM_INIT == 1
        ddr_unary_cost_layer1, ddr_im0_gray_layer1, cost_blk, label_blk, disp_blk, init_cost_blk, init_label_blk, init_disp_blk, ddr_cost, ddr_label, ddr_disp);
#else
    localExpLayer1(l0_random_num, ddr_unary_cost_layer1, ddr_im0_gray_layer1, cost_blk0, label_blk0, disp_blk0, cost_blk1, label_blk1, disp_blk1);
    localExpLayer2(ddr_unary_cost_layer2, ddr_im0_gray_layer2, cost_blk1, label_blk1, disp_blk1, ddr_cost, ddr_label, ddr_disp);
#endif
#elif COST_CALC_MODE == 1
