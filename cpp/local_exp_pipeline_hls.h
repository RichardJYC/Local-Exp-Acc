...
#ifndef WIDTH
#define WIDTH 722  // 105
#endif
#ifndef HEIGHT
#define HEIGHT 480 // 75
#endif
#ifndef DISP_MAX
#define DISP_MAX 190 // to be reduced to 192
#endif
#define DISP_MIN 0 // fixed to 0

#define DISP_DDR_BIT 6 // bits of 1 cost value; to be reduced to 8
...
#define LAYER0_PROP_NUM 2
#define LAYER1_PROP_NUM 2

#define LAYER0_PROP_LOOP 8
